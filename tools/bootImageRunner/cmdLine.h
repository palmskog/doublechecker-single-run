...
static const char* nonStandardArgs[numNonstandardArgs] = {
   ...
   "-X:benchmarkCategory=", // AVD: Adding a non-standard argument to identify benchmark category
};
...
static const char* nonStandardUsage[] = {
   ...
   // AVD: Adding a non-standard argument to identify benchmark category
   "  -X:benchmarkCategory=<num> AVD specific, pass benchmark identification information to the RVM, check EXP for values",
