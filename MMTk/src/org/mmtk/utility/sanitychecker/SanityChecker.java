...
public final class SanityChecker implements Constants {
  ...
  public boolean collectionPhase(int phaseId) {
    ...
    if (phaseId == Simple.SANITY_PREPARE) {
      ...
      // AVD: Printing additional information to help debugging
      Log.write(VM.activePlan.global().isCurrentGCNursery() ? "Nursery GC" : "Full Heap GC");
      Log.writeln(" # ", VM.objectModel.getGCCollectionNumber());
