...
public abstract class Gen extends StopTheWorld {
  ...
  // AVD: A shared deque to construct a producer-consumer relationship for tracing log buffers in Octet threads. 
  public final SharedDeque avdOctetThreadsPool = new SharedDeque("octetThreads", metaDataSpace, 1);
  ...
  public void collectionPhase(short phaseId) {
    ...
    if (phaseId == PREPARE) {
      ...
      // AVD: Clear the pool both for full-heap and nursery GC
      avdOctetThreadsPool.clearDeque(1);
