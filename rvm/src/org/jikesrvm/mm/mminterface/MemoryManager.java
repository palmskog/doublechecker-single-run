...
public final class MemoryManager implements HeapLayoutConstants, Constants {
  ...
  /** AVD: Track whether end harness has been reached */
  @Inline
  public static final boolean isHarnessEndReached() {
    return Plan.harnessEndReached;
  }
  ...
  // AVD: Allocate read/write set from separate AVD space
  /**
   * @param numElements number of elements in the word array (in words)
   * @return
   */
  @Inline
  public static Object createAVDSpace(int numElements) {
    return org.mmtk.vm.VM.objectModel.createAVDSpace(numElements);
  }
