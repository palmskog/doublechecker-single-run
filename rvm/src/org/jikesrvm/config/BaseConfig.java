...
public class BaseConfig {
  ...
  /** Use a per-thread hash table to identify duplicate accesses. */
  @Pure
  ...
  /** This is just for AVD-specific stats */
  @Pure
  ...
  @Pure
  public boolean testHashTableClear() {
    return false;
  }
  ...
  @Pure
  public boolean traceReadWriteSetAsStrongReferences() {
    return false;
  }
  ...
  @Pure
  public boolean oldGrowAndCopyHashSet() {
    return false;
  }
