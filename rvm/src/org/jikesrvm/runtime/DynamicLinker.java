...
public class DynamicLinker implements Constants {
  ...
  static void lazyMethodInvoker() {
    ...
    // AVD: Context: Walk stack to find caller, note if it is application
    ...
    // AVD: Context: This is bad, but "methodRef" can be a library type, while the targMethod is an application method
    if (currentThread.isOctetThread()) {
