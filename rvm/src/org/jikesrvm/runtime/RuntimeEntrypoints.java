...
public class RuntimeEntrypoints implements Constants, ArchitectureSpecific.StackframeLayoutConstants {
  ...
  static void unexpectedAbstractMethodCall() {
    ...
    // AVD: Context: Added this to aid in debugging
    RVMThread.dumpStack();
  ...
  static void deliverHardwareException(int trapCode, int trapInfo) {
    ...
    // AVD: Stack overflow: Fail assertion for stack overflow. How can we do this better?
  ...
  static void unlockAndThrowWithoutInstrumentation(Object objToUnlock, Throwable objToThrow) {
    ObjectModel.genericUnlockWithoutAVDInstrumentation(objToUnlock);
    athrow(objToThrow);
  }
