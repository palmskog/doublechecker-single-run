...
public class Entrypoints {
  ...
  // AVD: Lock methods with instrumentation
  ...
  public static final NormalMethod inlineLockMethod =
      getMethod(org.jikesrvm.scheduler.ThinLock.class, "inlineLock", "(Ljava/lang/Object;Lorg/vmmagic/unboxed/Offset;)V");
  public static final NormalMethod inlineUnlockMethod = 
      getMethod(org.jikesrvm.scheduler.ThinLock.class, "inlineUnlock", "(Ljava/lang/Object;Lorg/vmmagic/unboxed/Offset;)V");
  
  // AVD: Lock methods without instrumentation
  
  public static final NormalMethod lockMethodWithoutAVDInstrumentation = 
      getMethod(org.jikesrvm.objectmodel.ObjectModel.class, "genericLockWithoutAVDInstrumentation", "(Ljava/lang/Object;)V");
  public static final NormalMethod unlockMethodWithoutAVDInstrumentation = 
      getMethod(org.jikesrvm.objectmodel.ObjectModel.class, "genericUnlockWithoutAVDInstrumentation", "(Ljava/lang/Object;)V");
  
  public static final NormalMethod inlineLockMethodWithoutAVDInstrumentation = 
      getMethod(org.jikesrvm.scheduler.ThinLock.class, "inlineLockWithoutAVDInstrumentation", "(Ljava/lang/Object;Lorg/vmmagic/unboxed/Offset;)V");
  public static final NormalMethod inlineUnlockMethodWithoutAVDInstrumentation = 
      getMethod(org.jikesrvm.scheduler.ThinLock.class, "inlineUnlockWithoutAVDInstrumentation", "(Ljava/lang/Object;Lorg/vmmagic/unboxed/Offset;)V");
  ...
  // AVD: Field for outgoing edges
  public static final RVMField avdOutgoingEdgesListField = getField(org.jikesrvm.atomicity.AVDNode.class, "outgoingEdgesList", org.jikesrvm.atomicity.AVDNodeList.class);

  // AVD: Creating entry points so as to compute the field offset, this is required for treating this as a weak reference
  public static final RVMField avdLastTransToPerformWrExToRdExField = getField(org.jikesrvm.scheduler.RVMThread.class, "lastTransToPerformWrExToRdEx", org.jikesrvm.atomicity.AVDNode.class);
  public static final RVMField avdLastTransToUpdateGlobalRdShCounter = getField(org.jikesrvm.atomicity.AVD.class, "lastTransToUpdateGlobalRdShCounter", org.jikesrvm.atomicity.AVDNode.class);
  
  // AVD: Added entry points to track start/end of transactions and for instrumentation
  public static final NormalMethod avdStartTransactionMethod = getMethod(org.jikesrvm.atomicity.AVDAnalysis.class, "startTransaction", "(II)V");
  public static final NormalMethod avdEndTransactionMethod = getMethod(org.jikesrvm.atomicity.AVDAnalysis.class, "endTransaction", "(II)V");
  public static final NormalMethod avdcheckMethodContextAtPrologMethod = getMethod(org.jikesrvm.atomicity.AVDAnalysis.class, "checkMethodContextAtProlog", "()V"); 
  
  // AVD: Read/write barriers

  public static final NormalMethod avdFieldReadBarrierResolvedMethod = getMethod(org.jikesrvm.atomicity.AVDBarriers.class, "fieldReadBarrierResolved", "(Ljava/lang/Object;III)V");
  public static final NormalMethod avdFieldWriteBarrierResolvedMethod = getMethod(org.jikesrvm.atomicity.AVDBarriers.class, "fieldWriteBarrierResolved", "(Ljava/lang/Object;III)V");

  public static final NormalMethod avdFieldReadBarrierStaticResolvedMethod = getMethod(org.jikesrvm.atomicity.AVDBarriers.class, "fieldReadBarrierStaticResolved", "(Lorg/vmmagic/unboxed/Offset;III)V");
  public static final NormalMethod avdFieldWriteBarrierStaticResolvedMethod = getMethod(org.jikesrvm.atomicity.AVDBarriers.class, "fieldWriteBarrierStaticResolved", "(Lorg/vmmagic/unboxed/Offset;III)V");

  public static final NormalMethod avdFieldReadBarrierUnresolvedMethod = getMethod(org.jikesrvm.atomicity.AVDBarriers.class, "fieldReadBarrierUnresolved", "(Ljava/lang/Object;III)V");
  public static final NormalMethod avdFieldWriteBarrierUnresolvedMethod = getMethod(org.jikesrvm.atomicity.AVDBarriers.class, "fieldWriteBarrierUnresolved", "(Ljava/lang/Object;III)V");

  public static final NormalMethod avdFieldReadBarrierStaticUnresolvedMethod = getMethod(org.jikesrvm.atomicity.AVDBarriers.class, "fieldReadBarrierStaticUnresolved", "(III)V");
  public static final NormalMethod avdFieldWriteBarrierStaticUnresolvedMethod = getMethod(org.jikesrvm.atomicity.AVDBarriers.class, "fieldWriteBarrierStaticUnresolved", "(III)V");

  public static final NormalMethod avdArrayReadBarrierMethod = getMethod(org.jikesrvm.atomicity.AVDBarriers.class, "arrayReadBarrier", "(Ljava/lang/Object;IIII)V");
  public static final NormalMethod avdArrayWriteBarrierMethod = getMethod(org.jikesrvm.atomicity.AVDBarriers.class, "arrayWriteBarrier", "(Ljava/lang/Object;IIII)V");
  ...
  // AVD: Context: We now have 3 resolved contexts
