...
public final class Site {
  ...
  // AVD: LATER: Why does AVD configs often require higher values?
  public static final int MAX_SITES = 1 << 22; // 4M sites
  ...
  public static int getSite(RVMMethod method, int bci, Site caller) {
    ...
    // AVD: Context: APP context now means TRANS/NONTRANS
