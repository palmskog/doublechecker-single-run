...
public class Stats implements Constants {
  ...
  // AVD: Stats for Phase 1 and Phase 2 
  public static final ThreadSafeCounter numRdExToRdSh = new ThreadSafeCounter("AVDNumRdExToRdSh", false);
  public static final ThreadSafeCounter numRdShFence = new ThreadSafeCounter("AVDNumRdShFence", false);
  public static final ThreadSafeCounter numConflicting = new ThreadSafeCounter("AVDNumConflicting", false);
  public static final ThreadSafeCounter numRdShWrEx = new ThreadSafeCounter("AVDNumRdShWrEx", false);
  public static final ThreadSafeCounter numOtherConflicts = new ThreadSafeCounter("AVDNumOtherConflicts", false);
  public static final UnsyncHistogram edgeListTraversals = new UnsyncHistogram("AVDEdgeListTraversals", false, 512);
