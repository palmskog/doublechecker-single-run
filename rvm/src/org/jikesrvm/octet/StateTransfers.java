...
public class StateTransfers extends OctetState {
  ...
  // AVD: Commenting out stats and other assertion code to help the opt compiler do less work
  @Inline
  @Entrypoint
  public static boolean read(Address baseAddr, Offset octetOffset, int fieldOrIndexInfo, int siteID) {
    ...
    // A nice guarantee.
    // AVD: Disabled this assertion since AVD tracks locks and thread synchronization primitives
