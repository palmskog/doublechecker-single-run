...
import org.jikesrvm.compilers.opt.AVDBasicBlockNumbering;
...
//        // AVD: Print IR immediately after Octet instrumentation
//        new IRPrinter("After Octet Instrumentation") {
//          @Override
//          public boolean shouldPerform(OptOptions options) {
...
//        },
        ...
        // AVD: Debug phase to check for basic block numbering
        new AVDBasicBlockNumbering(false),
