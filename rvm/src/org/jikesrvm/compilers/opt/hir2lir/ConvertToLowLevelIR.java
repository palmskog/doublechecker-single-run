  ...
  public static Instruction callHelper(Instruction v, IR ir) {
    ...
    if (methOp.isStatic()) {
      ...
      if (VM.BuildForIMTInterfaceInvocation) {
        ...
        InterfaceMethodSignature sig = InterfaceMethodSignature.findOrCreate(methOp.getMemberRef(), context); // AVD: Changed parameter
        ...
        if (itableIndex == -1) {
          ...
          Instruction vp =
              Call.create3(CALL,
                           ...
                           IC(context)); // AVD: Changed parameter
