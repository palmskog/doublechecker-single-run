...
public final class Class<T> implements Serializable, Type, AnnotatedElement, GenericDeclaration {
  ...
  // AVD: Context: Helper method to search for default ctor with given "context". We cannot cache the default
  ...
  public T newInstance() throws IllegalAccessException, InstantiationException,
    ...
    // AVD: Context: The call here can come from a library method, so basically we will walk up the stack to find
