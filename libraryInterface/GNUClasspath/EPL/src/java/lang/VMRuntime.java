...
public final class VMRuntime {
  ...
  static void runFinalizationForExit() {
    // AVD: Trying to implement this functionality
    if (runFinalizersOnExit) {
      // TODO: talk to Steve B & Perry and figure out what to do.
      // throw new UnimplementedError();
    }
    if (AVD.useDebugNodes() && AVD.methodsAsTransactions()) { // No need to bother about finalizers for performance runs
      FinalizableProcessor.getProcessor().runFinalizationOnExit();
    }
  }
